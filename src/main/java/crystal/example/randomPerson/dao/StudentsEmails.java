package crystal.example.randomPerson.dao;

public class StudentsEmails {

    public static final String[] FIRST_CLASS_EMAILS = new String[]{"danjel.halili@crystal-system.eu", "flavio.lorenci@crystal-system.eu", "elia.omeri@crystal-system.eu", "ardit.elezi@crystal-system.eu",
